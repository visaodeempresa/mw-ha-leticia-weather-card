...
REPO = "visaodeempresa/mw-ha-leticia-weather-card"          # dono/repositório no GitHub
NOME = "mw-ha-leticia-weather-card"                    # a pasta em /config/www/community
CARD = "mw-leticia-weather-card"                    # o arquivo .js, sem extensão
